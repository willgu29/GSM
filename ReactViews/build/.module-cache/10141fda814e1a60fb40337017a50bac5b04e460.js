		...
		return(	
			...
			React.createElement("h4", null, "Edit Account"), 
			 React.createElement("form", {className: "editAccountForm", method: "post", action: "editAccount"}, 
                ...
                "Tell us something interesting about yourself: ", React.createElement("input", {type: "text", name: "email", placeholder: "separate with commas only (no spaces)"}), " ", React.createElement("br", null), 
