	...
	render: function () {
		...
		return(
			React.createElement("div", null, 
				...
				React.createElement("p", null, "Skills: ", this.state.skills), 
				React.createElement("p", null, "Personality: ", this.state.personality), 
				React.createElement("p", null, "Can Offer: ", this.state.canOffer), 
				React.createElement("p", null, "Wants: ", this.state.wants)
			)
