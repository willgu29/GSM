...
var SubmitMediaForm = React.createClass({displayName: "SubmitMediaForm",
  getInitialState: function() {
	...
	render: function() {
      ...
      React.createElement("input", {id: "mediaFile", type: "file", value: this.state.mediaFile, name: "audio", onChange: this.handleChange, ref: "mediaFile", accept: "audio/*"}), 
