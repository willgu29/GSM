		...
		return(	
			...
			React.createElement("h4", null, "Edit Account"), 
			 React.createElement("form", {className: "editAccountForm", method: "post", action: "editAccount"}, 
                ...
                "Add what you are looking for: ", React.createElement("input", {type: "text", name: "wants", placeholder: "separate with commas only (no spaces)"}), " ", React.createElement("br", null), 
