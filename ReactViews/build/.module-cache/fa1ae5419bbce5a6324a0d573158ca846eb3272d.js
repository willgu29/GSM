		...
		return(	
			...
			React.createElement("h4", null, "Edit Account"), 
			 React.createElement("form", {className: "editAccountForm", method: "post", action: "api/users/me"}, 
                ...
                React.createElement("input", {size: "60", type: "text", name: "skills", value: this.state.user.identity.skills, placeholder: "separate with commas only (no spaces)"}), " ", React.createElement("br", null), 
