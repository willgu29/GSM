...
var SubmitMediaForm = React.createClass({displayName: "SubmitMediaForm",
  getInitialState: function() {
    ...
    xhr.onreadystatechange = function(){
        if(xhr.readyState === 4){
            if(xhr.status === 200){
                ...
                upload_file(this.state.mediaFile, response.signed_request, response.url);
            }
            else{
	...
	render: function() {
      ...
      React.createElement("input", {id: "file_input", type: "file", name: "file_input", value: this.state.mediaFile, onChange: this.handleChange, accept: "audio/*"}), 
