var EditAccountForm = React.createClass({displayName: "EditAccountForm",
	...
	render: function() {
        ...
        // if (userData.contactIf == undefined) {
        //     console.log("Contact undefined");
        // } else if (userData.contactIf[0] == undefined) {
        //     console.log("contact still fucked");
        // } else if (userData["contactIf"] == undefined) {
        //     console.log("Contact fuck fuck");
        // } else if (userData) {
		...
		return(	
			...
			React.createElement("h4", null, "Edit Account"), 
			 React.createElement("form", {className: "editAccountForm", method: "post", action: "api/users/me"}, 
                ...
                React.createElement("input", {size: "60", type: "text", name: "skills", defaultValue: userString, placeholder: "separate with commas only (no spaces)"}), " ", React.createElement("br", null), 
