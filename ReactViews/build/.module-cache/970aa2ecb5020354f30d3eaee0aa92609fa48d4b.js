var EditAccountForm = React.createClass({displayName: "EditAccountForm",
	...
	render: function() {
        ...
        for (var i=0; i < personalityDisplay.length; i++) {
            var personalityTrait = personalityDisplay[i];
            personalityDisplay = personalityDisplay + " " + personalityTrait;
        }
        for (var i=0; i < skillsDisplay.length; i++) {
            var skillsTrait = skillsDisplay[i];
            ...
            React.createElement("div", null, 
			 React.createElement("h4", null, "Edit Account"), 
			  React.createElement("form", {className: "editAccountForm", method: "post", action: "api/users/me"}, 
                    ...
                    React.createElement("input", {id: "personality", size: "60", type: "text", name: "personality", value: personalityDisplay}), " ", React.createElement("br", null), 
                    React.createElement("br", null), 
