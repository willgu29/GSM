		...
		return(	
			...
			React.createElement("h4", null, "Edit Account"), 
			 React.createElement("form", {className: "editAccountForm", method: "post", action: "editAccount"}, 
                ...
                "Why should someone contact you? (things you want/things you can give perhaps) ", React.createElement("input", {type: "text", name: "contactIf", placeholder: "separate with commas only (no spaces)"}), " ", React.createElement("br", null), 
                ...
                React.createElement("input", {type: "submit", value: "edit account", id: "api/users/me"})
            )
            )
...
React.render(React.createElement(CreateAccountForm, {url: "/api/users/me"}), document.getElementById("editAccountForm"));
