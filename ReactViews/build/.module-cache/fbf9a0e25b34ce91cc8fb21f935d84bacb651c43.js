	...
	render: function() {
		return(
			React.createElement("div", null, 
				...
				React.createElement("form", {method: "post", action: "/api/groups/"}, 
				...
				React.createElement(CreateSubGroup, null)
			)
		);
	}
...
var CreateSubGroup = React.createClass({displayName: "CreateSubGroup",
	...
	render: function() {
		return(
			React.createElement("form", {method: "post", action: this.state.actionURL}, 
