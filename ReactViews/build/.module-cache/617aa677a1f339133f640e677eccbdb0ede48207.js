		...
		return(
			React.createElement("div", null, 
				React.createElement("form", {className: "loginForm", onsubmit: this.handleLoginSubmit, method: "post"}, 
					"First Name: ", React.createElement("input", {type: "text", name: "firstName", placeholder: "first name"}), 
					"Last Name: ", React.createElement("input", {type: "text", name: "lastName", placeholder: "last name"}), 
