var EditAccountForm = React.createClass({displayName: "EditAccountForm",
    ...
    componentDidMount: function() {
        $.ajax({
            ...
            if (this.isMounted()){
                this.setState({
                                interesting: userData.interesting,
            ...
            React.createElement("div", null, 
			 React.createElement("h4", null, "Edit Account"), 
			  React.createElement("form", {className: "editAccountForm", method: "post", action: "api/users/me"}, 
                    ...
                    React.createElement("textarea", {name: "interesting", value: this.state.interesting, onChange: this.handleChange, cols: "60", row: "10"}), " ", React.createElement("br", null), 
                    React.createElement("br", null), 
