		...
		return(	
			...
			React.createElement("h4", null, "Edit Account"), 
			 React.createElement("form", {className: "editAccountForm", method: "post", action: "api/users/me"}, 
                ...
                React.createElement("input", {size: "60", type: "text", name: "personality", value: this.state.user.identity.personality, placeholder: "separate with commas only (no spaces)"}), " ", React.createElement("br", null), 
                React.createElement("br", null), 
