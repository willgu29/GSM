var EditAccountForm = React.createClass({displayName: "EditAccountForm",
	...
	render: function() {
        ...
        // }
        console.log("CONTACT FUCKER " + contactIfDisplay);
		return(	
            React.createElement("div", null, 
			 React.createElement("h4", null, "Edit Account"), 
			  React.createElement("form", {className: "editAccountForm", method: "post", action: "api/users/me"}, 
                    ...
                    React.createElement("input", {id: "skills", size: "60", type: "text", name: "skills", defaultValue: skillsDisplay}), " ", React.createElement("br", null), 
                    React.createElement("br", null), 
                    "Add personality traits: (separate with commas only (no spaces))  ", React.createElement("br", null), 
                    React.createElement("input", {id: "personality", size: "60", type: "text", name: "personality", defaultValue: personalityDisplay}), " ", React.createElement("br", null), 
                    React.createElement("br", null), 
                    "Why should someone contact you? (things you want/things you can give perhaps) ", React.createElement("br", null), 
                    React.createElement("textarea", {id: "contactIf", name: "contactIf", defaultValue: this.state.contactIf, onChange: this.handleChange, cols: "60", row: "10"}), " ", React.createElement("br", null), React.createElement("br", null), 
                    React.createElement("br", null), 
