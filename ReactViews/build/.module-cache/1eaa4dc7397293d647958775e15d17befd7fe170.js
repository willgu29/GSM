		...
		return(	
			...
			React.createElement("h4", null, "Edit Account"), 
			 React.createElement("form", {className: "editAccountForm", method: "post", action: "api/users/me"}, 
                ...
                "Tell us something interesting about yourself: ", React.createElement("br", null/), React.createElement("textarea", {name: "interesting", cols: "60", row: "20"}), " ", React.createElement("br", null), 
