var FundooRating = React.createClass({displayName: "FundooRating",
  render: function() {
    var items = [];
...
var FundooDirectiveTutorial = React.createClass({displayName: "FundooDirectiveTutorial",
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        ...
        React.createElement(FundooRating, {value: this.state.rating, max: "10", onRatingSelected: this.handleRatingSelected}), 
        React.createElement("br", null), 
        "Readonly rating ", React.createElement("br", null), 
        React.createElement(FundooRating, {value: this.state.rating, max: "10"})
      )
    );
  }
});
...
React.render(React.createElement(FundooDirectiveTutorial, null), document.body);
